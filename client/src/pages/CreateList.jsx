...
import { useSelector } from 'react-redux'; //only for user state
import { useNavigate } from 'react-router-dom'; //only for navigating to list of the id 
    ...
    <div className='flex flex-col flex-1 gap-4'>
      ...
      <div className='flex gap-4'>
        <input
          ...
          className='p-3 border border-gray-300 rounded w-full focus:outline-none focus:ring-2 focus:ring-indigo-600'
          type='file'
          id='images'
        ...
        formData.imageUrls.map((url, index) => (
          ...
          >
            ...
            <button
              ...
              className='p-2 text-red-700 border border-red-700 rounded-lg uppercase hover:bg-red-700 hover:text-white'
            >
              Delete
            </button>
          </div>
      ...
      <button
        ...
        className='p-3 bg-indigo-600 text-white rounded-lg uppercase hover:bg-indigo-700 disabled:opacity-80'
      >
